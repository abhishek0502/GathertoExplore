<%@page import="user89.pojo.EventRequest"%>
						...
						<div class="collapse navbar-collapse" style="margin-left: 100px; width: 800px"
							...
							<li><a href="CreateLetsMeet.jsp" data-hover="Gallery">Create
										...
										<li ><a href="UpdateLetsMeet.jsp" data-hover="Gallery">Update My Event</a></li>
											<li class="active"><a href="ShowMyLetsMeet.ar" data-hover="Gallery">My Events</a></li>
...
ArrayList<EventRequest> al = (ArrayList<EventRequest>)session.getAttribute("recreq") ;

%>


<div class="container">
  <h2>All Recieved Requests On Your Events</h2>
           <br><br>
  <table class="table table-striped">

<tr>
<th>Event id</th>
<th>Username Of Requested user</th>

<th>Approved Or Not(Y/N)</th>
<th>Confirmed Or Not(Y/N)</th>
</tr>


<%
if(al!=null){
for(EventRequest p:al) 
{%>
<tr><td><%=p.getMeetid() %></td>
<td><form action="getuserdetails.ar" ><button class="btn btn-link" name="btname" value="<%=p.getName() %>"><%=p.getName() %></button></form></td>
<td><%=p.getUserapproved() %></td>
<td><%=p.getUserconfirm() %></td>
<%
if(!p.getUserapproved().equals("Approved")){%>
<td><form action="approverequest.ar"><button class="btn btn-success" style="background-color: gray;" name="btsend" value="<%= p.getMeetid()+p.getName() %>">Approve Request</button></form></td>

<td><form action="deleterequest.ar"><button class="btn btn-danger" name="btsend" value="<%= p.getMeetid()+p.getName() %>">Delete Request</button></form></td>
<%}%>
