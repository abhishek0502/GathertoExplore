...
<!-- 										Event</a></li> -->
			...
			<div
				style="margin-top: 50px; margin-left: 200px; height: 500px; width: 500px;">
			<form action="myletsmeetsearchd.ar" id="form1">

		<fieldset><legend>Search By Date</legend>
			

			<div class="form-group">
					<label class="col-md-4 control-label" for="txt5">From Date</label>
					<div class="col-md-6">
						<input id="mlocationcity" name="fdate" type="date" required
				...
				<br><br>
				<div class="form-group">
					<label class="col-md-4 control-label" for="txt5">To Date</label>
					<div class="col-md-6">
						<input id="mlocationcity" name="tdate" type="date" required
							placeholder="" class="form-control input-md">
