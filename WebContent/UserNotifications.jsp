<%@page import="user89.pojo.Notifications"%>
...
<%@page import="user89.dao.NotificationsDao"%>
...
ArrayList<Notifications> al = (ArrayList<Notifications>)session.getAttribute("usernotifications") ;
...
String msg=p.getStatus();
if(msg.equals("true")){
%>
<tr><td><%=p.getMessage() %></td>
<td><%=p.getNamefrom() %></td>
<%-- <td><%=p.getName() %></td> --%>
<%p.setStatus("false") ;
srdao.updateUser(p);
