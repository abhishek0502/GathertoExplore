				...
				<div class="container">
					<div class="navbar-top">
						...
						<div class="collapse navbar-collapse" 
							id="bs-example-navbar-collapse-1" style="margin-left: 100px; width: 800px">
							<ul class="nav navbar-nav link-effect-4" >
								<li class="active"><a href="Home.jsp" data-hover="Home">Home</a>
								</li>
...
<!-- 										<li><a href="SearchByDate.jsp">Search By Date</a></li> -->
					...
					<div class="header-left animated wow fadeInLeft animated"
						...
						<ul>
							...
							<%-- 							<li><i class="glyphicon glyphicon-user"></i>Welcome <%= name %></li> --%>
						...
						<ul class="slides">
							<li>
								<div class="w3l_banner_info">
									...
									<p>Do more of it with Lets Plan</p>
								</div>
							</li>
							<li>
								<div class="w3l_banner_info">
									<h3>Make new friends</h3>
									<p>Communities for popular hobbies help you get connected.</p>
								</div>
							</li>
							<li>
								<div class="w3l_banner_info">
									<h3>Your privacy matters</h3>
									<p>We respect your privacy and have created features that
										help protect it.</p>
								</div>
							</li>
							<li>
								<div class="w3l_banner_info">
									<h3>Welcome to Lets Plan</h3>
									<p>Our goal is to represent all of the opportunities that
										exist in a geographic area for an interest, so that
										enthusiasts can quickly get connected and find local groups,
										activities, places and other enthusiasts nearby or in places
										they plan to visit.</p>
								</div>
							</li>
							<li>
								<div class="w3l_banner_info">
									<h3>Events</h3>
									<p>Find activities happening near you and meet other local
										enthusiasts.</p>
								</div>
							</li>
						</ul>
	...
	<div class="welcome" id="welcome">
		<div class="container">
			...
			<div class="w3l-welcome-text">
				<p>DO MORE OF THE THINGS YOU LIKE WITH PEOPLE GOING OUT AROUND
					YOU Meet likeminded people. Share great times.</p>
			</div>
		</div>
	</div>
	<!-- //welcome -->
