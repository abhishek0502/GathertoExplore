						...
						<div class="collapse navbar-collapse" style="margin-left: 100px; width: 800px"
							...
							<li ><a href="Home.jsp" data-hover="Home">Home</a>
									...
									<li><a href="CreateLetsMeet.jsp" data-hover="Gallery">Create
										Event</a></li>
										<li class="active"><a href="UpdateLetsMeet.jsp" data-hover="Gallery">Update My Event</a></li>
...
<div
	...
	<form action="myletsmeetupdate.ar" id="form1">
		...
		<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="mmeetid" name="mmeetid" type="text" placeholder="" required
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="txt5">Location
						Address</label>
					<div class="col-md-6">
						<input id="mlocationaddress" name="mlocationaddress" type="text" required
							placeholder="" class="form-control input-md">
...
<!-- 				</div> -->
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="pw1">Select Category</label> 
					<div class="col-md-6"><select
						class="form-control" id="sel1" name="mcategory">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<textarea class="form-control" id="txt1" name="mdescription" required></textarea>
					</div>
				</div>
				<br> <br>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="txt4" name="mstartdate" type="date" placeholder="" required
							class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="txt4" name="mstarttime" type="time" placeholder="" required
							class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="txt4" name="menddate" type="date" placeholder="" required
							class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="txt4" name="mendtime" type="time" placeholder="" required
							class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<button id="bt1" name="bt1" class="btn btn-success" type="submit">UpdateMeet</button>
					</div>
				</div>
				<br> <br>
