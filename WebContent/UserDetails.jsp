...
<%@page import="user89.pojo.UserRegister"%>
...
<% 
UserRegister p = (UserRegister)session.getAttribute("userdetails") ;
...
<div class="container">
 ...
 if(p.getUsername().equals(name)){
	 %>
	 <a href="EditProfile.jsp"> <button style="margin-left: 650px" class="btn btn-primary" name="btsend">Edit Profile</button></a>
 <%}
 %>
...
<tr><td>Username</td><td><%=p.getUsername() %></td></tr>
<tr><td>Email</td><td><%=p.getEmail() %></td></tr>
<tr><td>Mobile Number</td><td><%=p.getMobile() %></td></tr>

<tr><td>Interests</td><td><%=p.getInterests() %></td></tr>
