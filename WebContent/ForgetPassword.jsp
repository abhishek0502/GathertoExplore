...
<div style="margin-top: 50px; margin-left: 500px; height: 300px ; width: 500px;">
		<form action="forgetpassword.ar">
<fieldset>

<!-- Text input  -->
<div class="form-group">
  <label class="col-md-4 control-label" for="txt1">Enter UserName</label>  
  <div class="col-md-4">
  <input id="txt1" name="fusername" type="text" placeholder=""
...
<!-- Text input  -->
<div class="form-group">
  <label class="col-md-4 control-label" for="txt1">Enter Email</label>  
  <div class="col-md-4">
  <input id="txt1" name="femail" type="text" placeholder=""
							class="form-control input-md">
...
<div class="form-group">
	...
	<div class="col-md-8" style="margin-top: 30px; margin-left: 100px;">
		<button id="bt1" name="bt1" class="btn btn-success" type="submit">Forget Password</button>
