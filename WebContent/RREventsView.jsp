...
ArrayList<MyLetsMeet> al = (ArrayList<MyLetsMeet>)session.getAttribute("myevents") ;

%>


<div class="container" style="margin-left: 30px">
  <h2>All My Created Events</h2>
           <br><br>
...
<td><%=p.getMendtime() %></td>
<td><%=p.getName() %></td>
<td><form action="allrrview.ar"><button class="btn btn-success" name="btsend" style="background-color: gray;" value="<%= p.getMmeetid() %>">View All Recieved Requests</button></form></td>
