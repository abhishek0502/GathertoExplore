...
ArrayList<EventRequest> al = (ArrayList<EventRequest>)session.getAttribute("sentreq") ;

%>


<div class="container">
  <h2>All Sent Requests</h2>
           <br><br>
  <table class="table table-striped">

<tr>
<th>Event id</th>
<th>Username Of User</th>
...
<%
if(!p.getUserconfirm().equals("Confirmed")&&p.getUserapproved().equals("Approved")){%>
<td><form action="confirmrequest.ar"><button style="background-color: gray;" class="btn btn-success" name="btsend" value="<%= p.getMeetid()+p.getName() %>">Confirm Request</button></form></td>
<%}%>
<%
if(!p.getUserconfirm().equals("Confirmed")){%>
