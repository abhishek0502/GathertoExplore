...
<font color="red"><b>${ msg }</b></font>
	...
	<div style="margin-top: 20px; margin-left: 500px; height: 300px ; width: 500px;">
		<form action="userlogin.ar" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txt1" name="username" type="text" placeholder="" required
...
<br>
<div class="form-group">
	<label class="col-md-4 control-label" for="pw1">Enter Password</label>
	<div class="col-md-4">
		<input id="txt2" name="password" type="password" placeholder="" required
			class="form-control input-md">
...
<div class="form-group">
	...
	<div class="col-md-8" style="margin-top: 30px; margin-left: 100px;">
		<button id="bt1" name="bt1" class="btn btn-success" type="submit">Login</button>
