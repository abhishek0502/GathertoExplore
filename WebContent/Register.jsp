...
<script type="text/javascript" src="ajax/userIDcheck.js"></script>
...
<div
				style="margin-top: 20px; margin-left: 400px; height: 500px; width: 500px;">
	<form action="userregister.ar" id="form1" onsubmit="return fun()">
		<fieldset>
		<legend>Registration Page</legend>
			<label id="msgUser"></label>
<!-- 				Form Name -->
...
<!-- 				Text input -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="rname" name="rname" type="text" placeholder="" required
...
<!-- 				Text input -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="rusername" name="rusername" type="text" placeholder="" required
							class="form-control input-md">
...
<!-- 				Text input -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="remail" name="remail" type="email" placeholder="" 
							class="form-control input-md">
...
<!-- 				Password input -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="rpassword" name="rpassword" type="password" placeholder="" required
							class="form-control input-md">
...
<!-- 				Password input -->
				<div class="form-group">
					<label class="col-md-4 control-label" for="pw2">Confirm
						Password </label>
					<div class="col-md-6">
						<input id="rcpassword" name="rcpassword" type="password" placeholder="" required
							class="form-control input-md">
...
<!-- 				Textarea -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<textarea class="form-control" id="rinterests" name="rinterests" required></textarea>
					</div>
				</div>
<br><br>
...
<!-- 				Text input -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input id="rmobile" name="rmobile" type="tel" placeholder="" required
							class="form-control input-md" min=10 max=10>
...
<!-- 				Button (Double) -->
				<div class="form-group">
					...
					<div class="col-md-8">
					<input id="form1" type="submit" name="bt1" class="btn btn-success" value="Register">
<!-- 						<button id="bt1" name="bt1" class="btn btn-success" type="submit" onclick="callback()">Register</button> -->
					</div>
				</div>
				<br><br>
