...
<div
	...
	<form action="updateprofile.ar" id="form1">
...
<!-- 				Password input -->
				<div class="form-group">
					<label class="col-md-4 control-label" for="pw2">Confirm
						Password </label>
					<div class="col-md-6">
						<input id="pw2" name="rcpassword" type="password" placeholder="" required
							class="form-control input-md">
...
<!-- 				Button (Double) -->
				<div class="form-group">
					...
					<div class="col-md-8">
						<button id="bt1" name="bt1" class="btn btn-success" type="submit">Update</button>
					</div>
				</div>
				<br><br>
