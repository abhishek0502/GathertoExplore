...
<%@page import="user89.pojo.MyLetsMeet"%>
					...
					<div class="navbar-top">
						...
						<div class="collapse navbar-collapse"
							...
							<li><a href="CreateLetsMeet.jsp" data-hover="Gallery">Create
										...
										<li ><a href="SearchLetsMeet.jsp" data-hover="Gallery">Search Event</a></li>
							</ul>
						</div>
						<!-- /.navbar-collapse -->
					</div>
...
<div style="margin-top: 50px; margin-left: 500px; height: 300px ; width: 500px;">
		<form action="newpassword.ar" method="post">
<fieldset>

<!-- Text input  -->
<div class="form-group">
  <label class="col-md-4 control-label" for="txt1">Enter New Password</label>  
  <div class="col-md-4">
  <input id="txt1" name="newpass" type="text" placeholder=""
...
<!-- Text input  -->
<div class="form-group">
  <label class="col-md-4 control-label" for="txt1">Confirm New Password</label>  
  <div class="col-md-4">
  <input id="txt1" name="newcpass" type="text" placeholder=""
							class="form-control input-md">
...
<div class="form-group">
	...
	<div class="col-md-8" style="margin-top: 30px; margin-left: 100px;">
		<button id="bt1" name="bt1" class="btn btn-success" type="submit">Submit</button>
