...
ArrayList<MyLetsMeet> al = (ArrayList<MyLetsMeet>)session.getAttribute("listbylocation") ;
...
{%>
<tr><td><%=p.getMmeetid() %></td>
<td><%=p.getMname() %></td>
<td><%=p.getMlocationcity() %></td>
<td><%=p.getMlocationaddress() %></td>

<td><%=p.getMcategory() %></td>
<td><%=p.getMdescription() %></td>
<td><%=p.getMstartdate() %></td>
<td><%=p.getMstarttime() %></td>
<td><%=p.getMenddate() %></td>

<td><%=p.getMendtime() %></td>
<td><form action="getuserdetails.ar" ><button class="btn btn-link" name="btname" value="<%=p.getName() %>"><%=p.getName() %></button></form></td>
<td><form action="sendrequest.ar" ><button  class="btn btn-success" style="background-color: gray;" name="btsend" value="<%= p.getMmeetid() %>">Send Request</button></form></td>
</tr>
