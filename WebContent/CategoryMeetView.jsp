...
ArrayList<MyLetsMeet> al = (ArrayList<MyLetsMeet>)session.getAttribute("listbycategory") ;
...
<td><form action="sendrequest.ar"><button style="background-color: gray;" class="btn btn-success" name="btsend" value="<%= p.getMmeetid() %>">Send Request</button></form></td>
</tr>
