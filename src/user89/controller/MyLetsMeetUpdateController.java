...
public class MyLetsMeetUpdateController implements Controller{
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		MyLetsMeet sr=srdao.getMeet(mmeetid);
		...
		srdao.updateMeet(mylets);
		return new ModelAndView("Home","msg","Event Successfully Updated");

		}
		else
		{
			
			return new ModelAndView("UpdateLetsMeet","msg","You have Entered Wrong Meetupid");
		}
